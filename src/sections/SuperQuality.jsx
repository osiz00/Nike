  ...
  return (
    ...
    max-lg:flex-col gap-10 w-full max-container">
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 info-text lg:max-w-lg">Enshuring premium comfort and  style, 
        out meticulously crafted footwear is designed to elevate your 
        experince, providing you with unmatched quality,
