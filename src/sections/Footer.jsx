        ...
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat
           text-white-400 sm:max-w-sm">
            Lorem ipsum dolor sit amet cons possimus dolores?
            Lorem ipsum dolor sit amet cons possimus dolores?
          </p>
          <div className="flex
           items-center gap-5 mt-8 mb-">
        ...
        text-white-400 mt-24 max-sm:flex-col
         max-sm:items-center">
          <div className="flex flex-1 items-center
           justify-start gap-2 font-montserrat
            cursor-pointer">
            ...
            cursor-pointer">Terms&Condtions</p>
       </div>
    </footer>
  )
}
